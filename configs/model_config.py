...
EMBEDDINGS_PATH = "/home/song/development/llm/embeddings/"
MODELS_PATH = "/home/song/development/llm/models/"
...
MODEL_PATH = {
    "embed_model": {
        "text2vec-base": os.path.join(EMBEDDINGS_PATH, "shibing624/text2vec-base-chinese"),
        "text2vec": os.path.join(EMBEDDINGS_PATH, "GanymedeNil/text2vec-large-chinese"),
        "text2vec-bge-large-chinese": os.path.join(EMBEDDINGS_PATH, "shibing624/text2vec-bge-large-chinese"),
        "m3e-base": os.path.join(EMBEDDINGS_PATH, "moka-ai/m3e-base"),
    },
    # TODO: add all supported llm models
    "llm_model": {
        # 以下部分模型并未完全测试，仅根据fastchat和vllm模型的模型列表推定支持
        "chatglm2-6b": os.path.join(MODELS_PATH, "THUDM/chatglm2-6b"),
        "chatglm2-6b-32k": os.path.join(MODELS_PATH, "THUDM/chatglm2-6b-32k"),
    },
}

# 选用的 Embedding 名称
EMBEDDING_MODEL = "text2vec-bge-large-chinese" # 可以尝试最新的嵌入式sota模型：piccolo-large-zh
